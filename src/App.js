...
const App = () => {
  ...
  const handleBuy = (id) => {
    ...
    if (!productToBuy || balance < productToBuy.price) {
      return;  
    }
    ...
    setBalance(prevBalance => prevBalance - productToBuy.price);
  };
  const handleSell = (id) => {
    ...
    setBalance(prevBalance => prevBalance + productToSell.price);
  };
  ...
  return (
    <div className="app">
      ...
      <img src="https://neal.fun/spend/billgates.jpg" alt="Bill Gates" className="bill-gates-image" />
